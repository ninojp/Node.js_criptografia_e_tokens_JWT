...
const mensagem = "Mensagem de demontraçao do curso ";
const chave = randomBytes(32);
//Vetor de inicializaçao(numero aleatório para aumentar a complexidade da senha)
...
console.log(`Msg Decifrada: ${mensagemDecifrada.toString("utf-8")}`);